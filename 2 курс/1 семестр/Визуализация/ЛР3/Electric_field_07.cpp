	...
	WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
		swprintf_s(S, 20, L"%6.2lf", -2.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT1), S);
		swprintf_s(S, 20, L"%6.2lf", 2.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT2), S);
		swprintf_s(S, 20, L"%6.2lf", -2.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT3), S);
		swprintf_s(S, 20, L"%6.2lf", 2.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT4), S);
		swprintf_s(S, 20, L"%6.2lf", 4.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT5), S);
		swprintf_s(S, 20, L"%6.2lf", 3.0);
		SetWindowText(GetDlgItem(hwndDlg, IDC_EDIT6), S);
		break;
	...
	case WM_COMMAND:
		...
		{
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT1), S, 20);
			xe1 = _wtof(S);
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT2), S, 20);
			xe2 = _wtof(S);
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT3), S, 20);
			ye1 = _wtof(S);
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT4), S, 20);
			ye2 = _wtof(S);
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT5), S, 20);
			dCentral = _wtof(S);
			GetWindowText(GetDlgItem(hwndDlg, IDC_EDIT6), S, 20);
			cCentral = _wtof(S);
			EndDialog(hwndDlg, 1);
		}
		break;
...
//			InvalidateRect(hwnd,NULL,TRUE);
		...
		case WM_COMMAND:
			...
			case ID_DATA:
				EndDial = (int)DialogBox(hInstApp, (LPCTSTR)IDD_DIALOG1, hwnd, DialProc);
				//создает диалоговое окно. 1-ый параметр - дескриптор экзепляра приложения
